...
class GreedyBustersAgent(BustersAgent):
    ...
    def chooseAction(self, gameState):
        ...
        for livingGhostPositionDistribution in livingGhostPositionDistributions:
            location = livingGhostPositionDistribution.argMax()
            ghosts.append(location)

        nextDistance = 99999
        for a in legal: 
            distance = self.distancer.getDistance(Actions.getSuccessor(pacmanPosition, a), min(ghosts))
